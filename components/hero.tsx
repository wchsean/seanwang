        ...
        >
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 drop-shadow-lg">
              Hi! I’m Sean Wang
              <span className="text-jungle-300"> Cybersecurity Meets Full-Stack Innovation</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-200 max-w-3xl mx-auto mb-8 drop-shadow">
              I’m a Cybersecurity Master’s Graduate and Full-Stack Developer with a focus on secure systems, scalable infrastructure, and web applications that solve real-world problems.
            </p>
